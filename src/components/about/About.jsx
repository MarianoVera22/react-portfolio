...
const About = () => {
  ...
  // Listas que vienen del CV. Se traducen via translations.js (about.intereses.X)
    ...
    <section className="about section" id="sobre-mi">
      ...
      <div className="about-container container grid">
        ...
        <div className="about-card">
          ...
          <h3 className="about-card-title">{t("about.interestsTitle")}</h3>
        ...
        <div className="about-card">
          ...
          <h3 className="about-card-title">{t("about.softSkillsTitle")}</h3>
          <div className="about-tags">
            {softSkills.map((key) => (
              <span key={key} className="about-tag">
        ...
        <div className="about-card">
          ...
          <h3 className="about-card-title">{t("about.languagesTitle")}</h3>
        ...
        <div className="about-card">
          ...
          <h3 className="about-card-title">{t("about.certificatesTitle")}</h3>
          <div className="about-card-body">
            <div className="about-row-single">Pearson English Interactive 3</div>
            <div className="about-row-single">Technical English for Software Developers</div>
          </div>
        </div>
