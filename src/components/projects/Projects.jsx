    ...
    <section className="projects section" id='proyectos'>
        ...
        <div className="projects-container container grid">
            <div className="projects-card">
                <img src={tesis} alt="tesis" className="projects-img" />
                <h3 className="projects-title">HAT de Raspberry Pi con sensor odométrico</h3>
            ...
            <div className="projects-card">
                ...
                <h3 className="projects-title">Streamer App con ASP.NET Core</h3>
